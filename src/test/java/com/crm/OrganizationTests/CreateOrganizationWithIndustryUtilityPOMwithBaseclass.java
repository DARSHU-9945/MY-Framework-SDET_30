...
public class CreateOrganizationWithIndustryUtilityPOMwithBaseclass extends BaseClass {
	...
	public void CreateOrganizationWithIndustryUtility() throws Throwable
	{
		...
		{
			Reporter.log(actHeader+"======Created and verified succesfully- Org with Ind type=======",true);
		}
		else
		{
