...
public class CreatePurchaseOrderWithItemTest {
	...
	public void CreatePurchaseOrderWithItemTest() throws Throwable
	{
		...
		//read data from excel sheet
				...
				//Reading item name  from excell sheet
				
				Cell cel111 = ro.getCell(7);
				String item=cel111.getStringCellValue();
				String itemRan=item+" "+random;
				
				//Reading vendor name from excell sheet
				
				Row ro1 = sh.getRow(3);
				Cell cel1111 = ro1.getCell(2);
				String VendorName = cel1111.getStringCellValue();
				
				//Reading product name  from excell sheet
				
				Row ro11 = sh.getRow(7);
				Cell cel11111 = ro11.getCell(3);
				String prdName = cel11111.getStringCellValue();
			...
			/*Step : 8 Navigate to products Link*/
			...
			/*Step 9: navigating to More link*/
				
				WebElement mouse1 = driver.findElement(By.linkText("More"));
				
				Actions act1 = new Actions(driver);
				
				act1.moveToElement(mouse1).perform();
				
			//*Step 10: Clicking on purchase order link and Create purchase Order*//
			...
			//*Step 11: Selecting the Item from the List//
				
				driver.findElement(By.id("searchIcon1")).click();
				
				Set<String> window1111 = driver.getWindowHandles();
				
				for(String WID : window1111) {
					
					driver.switchTo().window(WID);
				}
				
			//*Step 12: searching the item from the item list
				...
				Set<String> window11111 = driver.getWindowHandles();
				
				for(String WID : window11111) {
			...
			/*Step 13:** Signout of the application**/
				
				WebElement element = driver.findElement(By.xpath("//img[@src='themes/softed/images/user.PNG']"));
				Actions act11 = new Actions(driver);
				act11.moveToElement(element).perform();
