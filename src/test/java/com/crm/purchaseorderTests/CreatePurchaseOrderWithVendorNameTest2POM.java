...
public class CreatePurchaseOrderWithVendorNameTest2POM {
	...
	public void CreatePurchaseOrderWithVendorNameTest() throws Throwable
	{
		...
		cpop.CreatePurchaseorder(driver, SubjectName, VendorName, ContactName, BillingAdress, ShippingAdress, item, quantity);
